...
// //String inputNamaSampah(String namaSampah, String jenisSampah, String SUK,
// float hargaBeli, String tanggal); //1.
...
// // String inputTransaksiMember(String username, String tanggal, JenisSampah
// x, int jumlahSampah); //3. Masukin Transaksi

// // Iterable<Transaksi> findAllTransaksiBankSampah()//4.
// // String inputTransaksiKePusat(int kelurahan, String tanggalTransaksi,
// JenisSampah x, int jumlahSampah);//4.Masukin Transaksi Bank Sampah Kelurahan
// ke Pusat
// }